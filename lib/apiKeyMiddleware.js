...
async function connectToMongo() {
  try {
    ...
    throw new Error('Database connection failed'); // Throwing an error to handle it upstream
  }
}
...
export const apiKeyMiddleware = async (req, res, next) => {
  ...
  try {
    ...
    console.error('Error in API key middleware:', error.message); // Log the specific error message
